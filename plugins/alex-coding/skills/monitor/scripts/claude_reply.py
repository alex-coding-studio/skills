...
def marked_body(body):
    ...
    return text if text.endswith('From Claude 🤖') else text + '\n\nFrom Claude 🤖'
...
def main():
    parser = argparse.ArgumentParser(description='Publish an explicitly authorized PR reply with the Claude Agent marker')
