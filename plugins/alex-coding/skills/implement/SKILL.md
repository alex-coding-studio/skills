...
6. Handle current feedback under existing authorization. Create required follow-up Issues for independent non-blockers. A push or queue receipt is not resolution. Keep Monitor and Review attached to this exact PR; waiting invokes no model. Respect cumulative review limits and human-owned gates.
