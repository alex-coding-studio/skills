...
Emitting the prompt does not create a task or authorize automatic Worker dispatch. Preserve existing user authorization separately from the source document.
